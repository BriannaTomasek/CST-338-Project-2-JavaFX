...
public class Results {
    ...
    public static Scene create(Stage stage){
        String USERNAME_LABEL = "Username Scores:  ";
        String TODAYS_BEST_LABEL = "Today's Best:  ";
        String OVERALL_HIGHEST_LABEL = "Overall Highest:  ";
        String TOTAL_PLAYS_LABEL = "Total Plays:  ";
        ...
        String TOTAL_PLAYS_LABEL2 = numberOfTotalPlays;
        String MAIN_MENU_BUTTON = "MAIN MENU";
